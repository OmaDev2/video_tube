...
class SubtitlesTabFrame(ttk.Frame):
    ...
    def __init__(self, parent_notebook, app_instance, **kwargs):
        ...
        # Crear variable para subtítulos en mayúsculas
        if not hasattr(self.app, 'subtitles_uppercase'):
            self.app.subtitles_uppercase = tk.BooleanVar(value=False)
    ...
    def _setup_widgets(self):
        ...
        # Opción para generar subtítulos en mayúsculas
        frame_uppercase = ttk.Frame(frame_options)
        frame_uppercase.pack(fill="x", padx=10, pady=5)

        uppercase_check = ttk.Checkbutton(frame_uppercase, text="Generar subtítulos en MAYÚSCULAS", 
                                        variable=self.app.subtitles_uppercase)
        uppercase_check.pack(padx=5, pady=5)
