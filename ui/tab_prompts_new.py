...
class PromptsTabFrame(ttk.Frame):
    ...
    def _setup_prompt_editor(self, parent_frame):
        ...
        # Título del editor
        lbl_editor_title = ttk.Label(frame_editor, text="Editar Plantilla de Prompt", 
                                   font=("Helvetica", 12, "bold"))
        lbl_editor_title.pack(pady=(10, 20))
        ...
        self.text_system = tk.Text(system_frame, height=10, wrap="none", 
        ...
        self.text_user = tk.Text(user_frame, height=10, wrap="none", 
        ...
        self.text_negative = tk.Text(negative_frame, height=6, wrap="none", 
        ...
        btn_save = ttk.Button(frame_editor, text="Guardar Cambios", command=self._save_prompt)
